...
def generate_launch_description():
    ...
    remappings = [
                    ('rgb/image', '/cam_bottom/color/image_raw'),
                    ('depth/image', '/cam_bottom/depth/image_rect_raw'),
                    ('rgb/camera_info', '/cam_bottom/color/camera_info_modified'),
                    ('scan', '/scan')
                ]
    
    config_rviz = os.path.join(
        get_package_share_directory('vgo_description'), 'rviz', 'urdf_config.rviz'
    )
    ...
    return LaunchDescription([
        ...
        # change the below to true when launch in simulation
